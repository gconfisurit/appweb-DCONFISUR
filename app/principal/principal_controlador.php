...
//        $depos =  array_map(function($val) { return $val['codubi']; }, Almacen::todos());
        ...
        foreach ($datos as $key => $row) {
            ...
            if($row["almacen"]=='01'){
                ...
                if($row["almacen"]=='02'){
                        $almacen='Control de Muestra';
                }else{
                    if($row["almacen"]=='03'){
                        $almacen='Devoluciones de Mercancia';
                    }else{
                        if($row["almacen"]=='04'){
                            $almacen='Mercancia Vencida';

                        }else{
                            if($row["almacen"]=='05'){
                                $almacen='Auto Venta Zona Sur';
                            }else{
                                if($row["almacen"]=='06'){
                                $almacen='Faltante en Almacen';
                               } else{
                                    if($row["almacen"]=='07'){
                                    $almacen='Dañado en Almacen';
                                   }  else{

                                        if($row["almacen"]=='08'){
                                            $almacen='Cotillones Navideños';
                                        } 
