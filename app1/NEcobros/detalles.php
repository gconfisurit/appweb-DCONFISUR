    ...
    if (!PermisosHelpers::verficarAcceso( Functions::getNameDirectory() )) {
		...
		<section class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h2>Notas de Entrega Pendientes por Cobrar</h2>
					</div>
					<div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
							<li class="breadcrumb-item"><a href="../principal.php">Inicio</a></li>
							<li class="breadcrumb-item active">Notas de Entrega por Cobrar</li>
						</ol>
					</div>
				</div>
			</div>
			...
			<!-- BOX FORMULARIO -->
				...
				<div class="card card-info" id="tabla_detalle">
					<div class="card-header">
						<h3 class="card-title">Relación de Notas de Entrega por Cobrar</h3>
					</div>
					<div class="card-body table-responsive mt-2 p-0" style="width:100%; height:30%;">
							...
							<thead style="background-color: #17A2B8;color: white;">
								<tr>
									...
									if ($_GET['data']=='5') { ?>
										...
										<th class="text-center" title="<?=Strings::DescriptionFromJson('8_a_15')?>"><?=Strings::titleFromJson('8_a_15')?></th>
										<th class="text-center" title="<?=Strings::DescriptionFromJson('16_a_40')?>"><?=Strings::titleFromJson('16_a_40')?></th>
										<th class="text-center" title="<?=Strings::DescriptionFromJson('mas_40')?>"><?=Strings::titleFromJson('mas_40')?></th>
									<?php } ?>                                   
							...
							<tfoot style="background-color: #ccc;color: white;">
								<tr>
									...
									if ($_GET['data']=='5') { ?>
										...
										<th class="text-center"><?=Strings::titleFromJson('8_a_15')?></th>
										<th class="text-center"><?=Strings::titleFromJson('16_a_40')?></th>
										<th class="text-center"><?=Strings::titleFromJson('mas_40')?></th>
									<?php } ?>  
