...
class NExcobrar extends Conectar{
       ...
       parent::set_names();
        ...
        //QUERY
		 if($vendedor != 'Todos'){
          $sql = "SELECT 
          (select Descrip from DCONFISUR_PZO_D.dbo.SACONF) as Empresa,
        ...
        case 1:
          if ($vendedor != 'Todos') {
            ...
            DATEDIFF(DD, saacxc.fechae, CONVERT( date ,GETDATE()))as DiasTransHoy,
             ...
             (select Coordinador from DCONFISUR_PZO_D.dbo.SAVEND_02 where SAVEND_02.CodVend = saacxc.CodVend) as Supervisor
             from DCONFISUR_PZO_D.dbo.saacxc inner join saclie on saacxc.codclie = saclie.codclie 
