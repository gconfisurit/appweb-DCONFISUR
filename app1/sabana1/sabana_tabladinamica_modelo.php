...
class Tabladinamica extends Conectar{
    ...
    public function getCostosdEinventario($marca)
	{
		//LLAMAMOS A LA CONEXION QUE CORRESPONDA CUANDO ES SAINT: CONEXION2
		//CUANDO ES APPWEB ES CONEXION.
		$conectar = parent::conexion2();
		...
		(SELECT factorp from SACONF where CodSucu = 00000) as factor
                ...
                WHERE /*(saexis.existen > 0 OR saexis.exunidad > 0) AND*/ len(marca) > 0 AND saexis.codubic IN ('01') AND saprod.CodProd LIKE '$marca'
