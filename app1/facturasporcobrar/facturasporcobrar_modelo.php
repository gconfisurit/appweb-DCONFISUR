	...
	public function getfacturasporcobrar($fechai, $fechaf){
       ...
       parent::set_names();
        ...
        if ($fechai == "" and $fechaf == ""){
          ...
          $sql = "SELECT 
                (select Descrip from [DCONFISUR_PZO].[dbo].SACONF) as Empresa,
                ...
                from [DCONFISUR_PZO].[dbo].saacxc inner join [DCONFISUR_PZO].[dbo].saclie on saacxc.codclie = saclie.codclie 
