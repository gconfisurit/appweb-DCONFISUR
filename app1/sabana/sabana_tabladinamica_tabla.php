...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Sabana Tabla Dinámica
                            (<?php
                            switch ($_GET['t']) {
        ...
        <div class="content">
            ...
            <table id="tabla" class="table table-sm text-center table-condensed table-bordered table-striped table-responsive table-primary" style="width:100%;">
                ...
                <tr id="cells">
                    ...
                    <th class="small align-middle">Costo $</th>
                    <th class="small align-middle">Total Costo $</th>
                    <th class="small align-middle">Rentabilidad Bruta $</th>
                    <th class="small align-middle">Rentabilidad Bruta %</th>
            ...
            <!-- /.container-fluid -->
            <div class="container">
                <a href="sabana_tabladinamica_excel.php?&fechai=<?php echo $_GET['fechai']; ?>&fechaf=<?php echo $_GET['fechaf']; ?>&vendedor=<?php echo $_GET['vendedor']; ?>&marca=<?php echo $_GET['marca']; ?>&t=<?php echo $_GET['t']; ?>" class="card-link" id="btn_excel">
    ...
    <script type="text/javascript" src="sabana_tabladinamica_tabla.js"></script>
</div>
<!-- ./wrapper -->
