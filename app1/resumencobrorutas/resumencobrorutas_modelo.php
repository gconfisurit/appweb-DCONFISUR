...
from [DCONFISUR_PZO].[dbo].SAPAGCXC as p 
inner join  [DCONFISUR_PZO].[dbo].SAACXC as c on p.NroPpal = c.NroUnico 
inner join  [DCONFISUR_PZO].[dbo].SACLIE as cl on c.CodClie = cl.CodClie
left join  [DCONFISUR_PZO].[dbo].SAACXC as cxc on cxc.NumeroD = p.NumeroD and cxc.TipoCxc in ('10','20')
...
from [DCONFISUR_PZO_D].[dbo].SAPAGCXC as p 
inner join  [DCONFISUR_PZO_D].[dbo].SAACXC as c on p.NroPpal = c.NroUnico 
inner join  [DCONFISUR_PZO_D].[dbo].SACLIE as cl on c.CodClie = cl.CodClie
left join  [DCONFISUR_PZO_D].[dbo].SAACXC as cxc on cxc.NumeroD = p.NumeroD and cxc.TipoCxc in ('10','20')
where DATEADD(dd, 0, DATEDIFF(dd, 0, p.FechaE))  between '$fechai' and '$fechaf' and p.TipoCxc in ('10','20') and c.TipoCxc in ('41')
) AS TOTAL 
GROUP BY EDV";
